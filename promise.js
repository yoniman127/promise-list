...
const arrays = ["make promises then keep them","only you are capable of your future","risk is better than regret",]
let index = 0
...
const dialog = document.getElementById("about-alert")
